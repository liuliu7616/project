...
<div class="adminme">
        <form method="post" class="form-x" action="<?php echo U('Teacher/modifyInfo');?>">
            ...
            <div class="form-group">
                ...
                <div class="field">
                    <div class="button-group radio"> 
                        <label class="button <?php echo $usrDetail['thrSex'] == 1 ? 'active' : null; ?>">
                            <input name="sex" value="1" <?php echo $usrDetail['thrSex'] == 1 ? 'checked="checked"' : null; ?> type="radio"><span class="icon icon-male"></span> 男
                        </label> 
                        <label class="button <?php echo $usrDetail['thrSex'] == 2 ? 'active' : null; ?>">
            ...
            <div class="form-group">
                <div class="label"><label for="usr_lvl">个人介绍</label></div>
                <div class="form-group">
                    <div class="field">
                      <div class="input-group">
             ...
             <div class="form-group">
                ...
                <div class="field">        
                    <input type="text" class="input" name="cname" size="50"  value="<?php echo ($cname[0][cName]); ?>"
                        disabled="true" />
                </div>
            </div>
            <div class="form-group">
                <div class="label"><label for="age">所教班级</label></div>
                <div class="field">        
                    <input type="text" class="input" name="teachingclass" size="50"  value="<?php echo ($classname[0]['majorName']); ?>"
                        disabled="true" />
                </div>
            </div>
              <!-- <div class="form-group">
