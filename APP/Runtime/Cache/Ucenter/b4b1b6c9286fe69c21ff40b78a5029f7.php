        ...
        <div class="lineme">
            <div class="xm2me bg22 contBox" style="height:100%;">
                ...
                <ul class="nav">
                    ...
                    <li><a href="<?php echo U('Student/choose_course');?>" class="lls active">选择课程</a></li>
                </ul>
                </aside>
            </div>
                ...
                <div class="admin-me">
                    <div class="panel admin-panel">
                        <div class="panel-head">
                            <form action="#" class="form-inline">
                                <div class="form-group">
                                    <div class="label"><label for="GPName">课程号</label></div>
                                    <div class="field">
                                ...
                                &nbsp;
                                <div class="form-group">
                                    <div class="label"><label for="GPKey">课程名</label></div>
                                    <div class="field">
                                ...
                                &nbsp;
                                <div class="form-group">
                                    <div class="label"><label for="GPThrName">教师</label></div>
                                    <div class="field">
                        ...
                        <table class="table table-hover table-striped table-bordered">
                            ...
                            <?php if(is_array($courseList)): $i = 0; $__LIST__ = $courseList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$index): $mod = ($i % 2 );++$i;?><tr>
                                <td><?php echo ($index["cId"]); ?></td>
                                <td><?php echo ($index["cNameId"]); ?></td>
                                <td>课程内容</td>
