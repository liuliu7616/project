...
<body>
    ...
    <div class="admin">
        ...
        <div class="panel admin-panel">
            ...
            <div class="padding border-bottom">
                ...
                <input type="button" class="button button-small border-blue dialogs" value="批量清除" name="clearsallbtn" href="#" data-toggle="click" data-target="#cleardialog" data-mask="1" data-width="30%" />
            ...
            <table class="table table-hover">
                ...
                <?php if(is_array($usrList)): $i = 0; $__LIST__ = $usrList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$index): $mod = ($i % 2 );++$i;?><tr>
                    <td>
                        <input type="checkbox" name="id" value="<?php echo ($index["adminId"]); ?>" />
                    </td>
                    ...
                    <td>
                        <?php echo $index['state'] == 1 ? '系统管理员' : '系统管理员'; ?>
                    </td>
                    <td>
                        <input name='adminid' type="hidden" value="<?php echo ($index["adminId"]); ?>" />
    ...
    <script>
        var ID = null;
        function recover(){
            window.location.href = "<?php echo U('Usr/recoverOne/id/" + ID + "');?>";
        }

        function clearr(){
            window.location.href = "<?php echo U('Usr/clearOne/id/" + ID + "');?>";
        }

        $(function(){
            $(".table a[name='recover']").click(function(){
                ID = $(this).parent().find("input[name='adminid']").val();
            });
