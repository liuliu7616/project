...
<div class="adminme">
        <form method="post" class="form-x" action="<?php echo U('Person/modifyInfo');?>">
            <div class="form-group">
                <div class="label"><label for="name">登陆账号</label></div>
                <div class="field">
                    <input type="text" class="input" name="usrname" size="50" value="<?php echo ($admininfo[0]['adminName']); ?>" disabled="disabled" />
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="field fieldme">
                    <div class="input-group">
                        ...
                        <input type="password" class="input" name="oldpwd" size="50" value="<?php echo ($admininfo[0]['adminPwd']); ?>" placeholder="请输入原始密码" disabled="disabled" />
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="field">
                    <input type="text" class="input" name="realName" size="50" placeholder="真实姓名" data-validate="required:请填写真实姓名" value="<?php echo ($admininfo[0]['adminRealName']); ?>" />
                </div>
            </div>
            <div class="form-group">
                <div class="label"><label for="age">用户年龄</label></div>
                <div class="field">
                    <input type="text" class="input" name="age" size="50" placeholder="用户年龄" data-validate="required:请填写用户年龄,number:用户年龄必须为整数" value="<?php echo ($admininfo[0]['adminAge']); ?>" />
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="field">
                    <div class="button-group radio"> 
                        <label class="button <?php echo $admininfo[0]['adminSex'] == 1 ? 'active' : null; ?> ">
                            <input name="sex" value="1"  <?php echo $admininfo[0]['adminSex'] == 1 ? 'checked="checked"' : null; ?>type="radio"><span class="icon icon-male"></span> 男
                        </label> 
                        <label class="button <?php echo $admininfo[0]['adminSex'] == 2 ? 'active' : null; ?>">
                            <input name="sex" value="2"  <?php echo $admininfo[0]['adminSex'] == 2 ? 'checked="checked"' : null; ?>type="radio"><span class="icon icon-female"></span> 女
                        </label> 
                    </div>
                </div>
            </div>
                ...
                <div class="form-group">
                    <div class="field">
                      <div class="input-group">
                        ...
                        <input type="text" class="input" name="Phone" size="50"  value="<?php echo ($admininfo[0]['adminPhone']); ?>" data-validate="required:请填写联系方式" />
                      </div>
                    </div>
                </div>
            <div class="form-group">
                ...
                <div class="form-group">
                    <div class="field">
                      <div class="input-group">
                        ...
                        <input type="text" class="input" name="Email" size="50"  value="<?php echo ($admininfo[0]['adminEmail']); ?>"
            ...
            <div class="form-group">
                <div class="label"><label for="address">家庭地址</label></div>
                <div class="form-group">
                    <div class="field">
                      <div class="input-group">
                        
                        <input type="text" class="input" name="Address" size="50"  value="<?php echo ($admininfo[0]['adminAddress']); ?>" data-validate="required:请填写办公地址" />
                      </div>
                    </div>
                </div>
            </div>
            ...
            <div class="form-button">
                <input type="hidden" name="usrId" value="<?php echo ($admininfo[0]['adminId']); ?>"/> 
